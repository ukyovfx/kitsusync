...
@media(max-width:760px){.production-users-heading{flex-direction:column}.production-users-heading .btn{width:100%}.production-users-toolbar{grid-template-columns:1fr}.production-user-role-form{grid-template-columns:1fr}.production-user-role-form .btn{width:100%}}
