...
.production-reviewer-manager{min-width:0}.reviewer-task-type-select,.reviewer-target-form{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:end;gap:10px}.reviewer-task-type-select label,.reviewer-target-form label{display:grid;gap:6px;min-width:0;color:var(--muted-2);font-size:.82rem}.reviewer-task-type-select select,.reviewer-target-form select{width:100%;min-width:0}.reviewer-group{display:grid;gap:6px;min-width:0}.reviewer-group h4{padding-top:2px}.reviewer-automatic-note{color:var(--muted-2)}.reviewer-target-list .reviewer-target-row{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center}.reviewer-target-row>span:first-child{display:grid;gap:3px;min-width:0;overflow-wrap:anywhere}.reviewer-target-row small{color:var(--muted-2)}.reviewer-target-add{display:grid;gap:12px}.reviewer-target-reset{display:flex;justify-content:flex-end}
