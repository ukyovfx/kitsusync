...
.page-card{border-radius:26px;padding:22px;}
.page-heading{display:flex;justify-content:space-between;gap:14px;align-items:flex-start;margin-bottom:14px;}
.page-heading h1{margin:0;font-size:28px;line-height:1.03;letter-spacing:-.03em;}
.page-heading p{margin:8px 0 0;color:var(--muted);line-height:1.6;}
.toast{border-radius:15px;padding:11px 13px;margin-bottom:14px;background:rgba(142,207,139,.1);border:1px solid rgba(142,207,139,.22);color:#d8f0d6;}
.dashboard-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;}
.tile{min-height:160px;padding:16px;border-radius:22px;position:relative;overflow:hidden;background:linear-gradient(180deg, rgba(255,255,255,.08), rgba(255,255,255,.03)),linear-gradient(140deg, rgba(232,90,26,.06), transparent 48%);border:1px solid rgba(255,255,255,.1);box-shadow:var(--shadow);transition:transform .18s ease, border-color .18s ease;}
...
.tile-icon{width:40px;height:40px;border-radius:15px;display:grid;place-items:center;margin-bottom:12px;color:var(--text);background:linear-gradient(180deg, rgba(255,255,255,.12), rgba(255,255,255,.04));border:1px solid rgba(255,255,255,.12);font-size:18px;}
.tile-title{font-size:17px;font-weight:600;letter-spacing:-.02em}
.tile-sub{margin-top:7px;color:var(--muted);line-height:1.5;font-size:12px}
.section-stack{display:grid;gap:14px}
.section-card{border-radius:22px;padding:16px;background:linear-gradient(180deg, rgba(255,255,255,.06), rgba(255,255,255,.03)),linear-gradient(135deg, rgba(232,90,26,.05), transparent 56%);}
.section-card h3{margin:0 0 7px;font-size:17px;letter-spacing:-.02em;}
...
input,select,textarea{width:100%;min-width:0;border-radius:15px;border:1px solid rgba(255,255,255,.12);background:rgba(8,8,10,.7);color:var(--text);padding:11px 13px;outline:none;transition:border-color .18s ease, box-shadow .18s ease, background .18s ease;}
...
.button-row{display:flex;gap:7px;align-items:center;flex-wrap:wrap;margin-top:14px;}
.btn,.btn-sm,.btn-ghost,.btn-danger{border:none;border-radius:999px;padding:9px 15px;cursor:pointer;font-weight:600;font-family:"Space Grotesk","Outfit",sans-serif;letter-spacing:.04em;transition:transform .18s ease, opacity .18s ease, box-shadow .18s ease;}
...
.btn-sm{color:#140904;background:linear-gradient(135deg, rgba(255,141,72,.94), rgba(232,90,26,.9));padding:7px 11px;}
...
.status-pill,.tag{display:inline-flex;align-items:center;gap:5px;padding:6px 9px;border-radius:999px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.08);color:var(--muted);font-size:10px;}
...
.table-wrap{overflow:auto;border-radius:18px;border:1px solid rgba(255,255,255,.08);background:rgba(4,4,6,.35);}
table{width:100%;border-collapse:collapse}
th,td{padding:10px 11px;border-bottom:1px solid rgba(255,255,255,.07);text-align:left;vertical-align:top;overflow-wrap:anywhere;word-break:break-word}
...
.empty{text-align:center;padding:20px 14px;border-radius:18px;border:1px dashed rgba(255,255,255,.16);background:rgba(255,255,255,.03);}
.metric-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:10px;}
.metric-card{border-radius:18px;padding:14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);}
.metric-label{color:var(--muted-2);font-size:12px;text-transform:uppercase;letter-spacing:.14em;}
.metric-value{margin-top:7px;font-size:20px;font-weight:600;letter-spacing:-.03em;}
.metric-value-host{font-size:17px;line-height:1.4;word-break:break-all;}
.metric-value-host code{display:inline-block;font-size:.92em;line-height:1.4;}
.accordion{border-radius:22px;overflow:hidden;border:1px solid rgba(255,255,255,.09);background:rgba(255,255,255,.04);}
.accordion summary{list-style:none;cursor:pointer;display:flex;justify-content:space-between;align-items:flex-start;gap:12px;padding:14px 16px;flex-wrap:wrap;}
...
.accordion-trigger{display:inline-flex;align-items:center;gap:7px;padding:6px 9px;border-radius:999px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);color:var(--text);font-family:"Space Grotesk","Outfit",sans-serif;font-size:10px;letter-spacing:.08em;text-transform:uppercase;}
.accordion-caret{width:28px;height:28px;border-radius:999px;display:grid;place-items:center;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.08);transition:transform .18s ease;}
...
.channel-groups{display:grid;gap:9px}
.channel-group{border:1px solid rgba(255,255,255,.08);border-radius:17px;padding:14px;background:rgba(255,255,255,.04)}
.channel-header{display:flex;justify-content:space-between;align-items:center;gap:10px;margin-bottom:8px;flex-wrap:wrap}
...
.delete-box{width:min(100%, 480px);max-height:min(88vh,720px);overflow:auto;padding:18px;border-radius:22px;}
.delete-title{margin:0 0 10px;font-size:20px;letter-spacing:-.03em;}
...
.sot-badge{display:flex;align-items:flex-start;gap:7px;padding:9px 12px;border-radius:11px;background:rgba(109,195,255,.08);border:1px solid rgba(109,195,255,.2);color:var(--text);font-size:.81rem;line-height:1.45;margin-bottom:4px}
.sot-badge .sot-icon{flex-shrink:0;font-size:1rem;margin-top:1px}
.sot-badge strong{color:#6dc3ff}
.notice-box{padding:9px 12px;border-radius:11px;background:rgba(142,207,139,.09);border:1px solid rgba(142,207,139,.25);color:var(--text);font-size:.81rem;line-height:1.5;margin-bottom:10px}
...
.workflow-overview{padding:18px;background:linear-gradient(180deg, rgba(255,255,255,.08), rgba(255,255,255,.03)),linear-gradient(135deg, rgba(109,195,255,.06), rgba(232,90,26,.05) 64%, transparent);}
.workflow-overview-head{margin-bottom:8px}
.workflow-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-top:10px}
.workflow-card{border-radius:17px;padding:13px 13px 14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);display:grid;gap:9px;align-content:start;min-height:168px}
.workflow-card h3{margin:0;font-size:15px;line-height:1.2}
...
.workflow-step-badge{width:26px;height:26px;border-radius:9px;display:grid;place-items:center;font-weight:700;font-family:"Space Grotesk","Outfit",sans-serif;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.1)}
...
.channel-preview-box{padding:11px 12px;border-radius:11px;background:rgba(109,195,255,.06);border:1px solid rgba(109,195,255,.15);margin-bottom:4px}
...
@media (max-width:900px){.topbar{flex-direction:column}.top-actions{width:100%;justify-content:flex-start}.page-card{padding:16px}.page-heading{flex-direction:column}.dashboard-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.workflow-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media (max-width:640px){.shell{padding:14px 10px 36px}.topbar{gap:12px}.top-actions{gap:7px}.brand-title{font-size:22px}.page-heading h1{font-size:23px}.page-card{width:auto!important;max-width:100%!important;margin-left:0!important;margin-right:0!important}.section-card{padding:14px;min-width:0}.dashboard-grid,.metric-grid,.form-grid,.workflow-grid{grid-template-columns:1fr}.form-span-2{grid-column:auto}.nav-card{width:100%}.lang-toggle{min-width:106px}.btn,.btn-sm,.btn-ghost,.btn-danger{max-width:100%;white-space:normal}.accordion{border-radius:18px}.accordion summary{padding:12px}.accordion-body{padding:0 10px 12px}.accordion-summary-main{flex-basis:100%}.accordion-summary-side{width:100%;justify-content:flex-start}.accordion-trigger{width:100%;justify-content:space-between}.project-panel-head{flex-direction:column}.project-panel-meta{width:100%;gap:8px}.project-panel-meta .tag{max-width:100%;white-space:normal}.project-panel-meta form,.project-panel-meta .btn-danger{width:100%}.table-wrap{margin:0 -2px}.project-channel-table{overflow:visible;background:transparent;border:none}.project-channel-table thead{display:none}.project-channel-table table,.project-channel-table tbody,.project-channel-table tr,.project-channel-table td{display:block;width:100%}.project-channel-table tr{margin:0 0 9px;padding:9px;border:1px solid rgba(255,255,255,.08);border-radius:15px;background:rgba(255,255,255,.035)}.project-channel-table td{padding:5px 0;border-bottom:none}.project-channel-table td::before{content:attr(data-label);display:block;margin-bottom:4px;color:var(--muted-2);font-size:11px;text-transform:uppercase;letter-spacing:.14em;font-family:"Space Grotesk","Outfit",sans-serif}.project-channel-table td:last-child{white-space:normal}.project-channel-table .delete-form{justify-content:stretch}.project-channel-table .delete-form .btn-danger{width:100%}.delete-modal{padding:10px}.delete-box{padding:14px;border-radius:16px}.metric-value-host{font-size:15px}.workflow-overview{padding:14px}.workflow-card{min-height:auto}.setup-steps{flex-wrap:wrap;row-gap:10px}}
@media (max-width:480px){.section-card{padding:10px;box-shadow:none}.glass{box-shadow:none}.shell{padding:8px 7px 32px}.hint{font-size:.8rem}.metric-label{font-size:.72rem}.metric-value{font-size:1.15rem}.section-card h3{font-size:.95rem}.table-wrap table{font-size:.78rem}.field-help,.field-label{font-size:.8rem}}
`
