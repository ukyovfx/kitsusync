...
func TestEditorialWorkbenchUsesRestrainedSurfaceContract(t *testing.T) {
	...
	for _, want := range []string{`class="page-card glass editorial-workbench"`, `.editorial-workbench{max-width:1088px;border-radius:12px;background:var(--panel);box-shadow:none}`, `.editorial-workbench h1,.editorial-workbench>.page-heading h1{font-size:32px;line-height:1.15;font-weight:600}`, `.editorial-workbench .page-heading>div>h2,.editorial-workbench .dashboard-menu>h2,.editorial-workbench .dashboard-cta>div>h2{font-size:24px;line-height:1.2;font-weight:600}`, `.editorial-workbench .page-heading>div>h3,.editorial-workbench .connections-card-header h2,.editorial-workbench .section-card>h2,.editorial-workbench .section-card>h3,.editorial-workbench .api-observation-card h3,.editorial-workbench .pipeline-health-item h3{font-size:18px;line-height:1.25;font-weight:600}`, `.editorial-workbench .field-help{font-size:14px;font-weight:400}`, `.editorial-workbench .status-pill,.editorial-workbench .status-badge,.editorial-workbench .dashboard-status-chip{font-weight:600}`, `.editorial-workbench .btn,.editorial-workbench .btn-sm,.editorial-workbench .btn-ghost,.editorial-workbench .btn-danger{min-height:40px;border-radius:8px}`, `.editorial-workbench .production-tabpanel>.section-card{border:0;border-top:1px solid var(--divider-color);border-radius:0;background:transparent;box-shadow:none;padding:20px 0 0}`, `.editorial-advanced-settings{display:grid;grid-template-columns:minmax(220px,.7fr) minmax(0,1.3fr);align-items:start;gap:16px 32px;border-top:1px solid var(--divider-color);padding-top:24px}`, `.editorial-advanced-settings>.connection-external-url-field{grid-column:2;grid-row:1}`, `.editorial-advanced-settings>.connection-expert-network{grid-column:1 / -1;grid-row:2}`, `.editorial-workbench .system-status-sections .system-observability-grid>article{display:grid;grid-template-rows:auto 1fr;min-height:224px;padding:16px;border:1px solid var(--border-default);border-radius:8px;background:var(--surface-subtle);box-shadow:none}`, `.system-status-sections .api-sparkline .chart-axis-label,.system-status-sections .api-sparkline .chart-tick,.system-status-sections .api-sparkline .chart-time-label{fill:var(--muted)}`, `.dashboard-service-status{display:grid;gap:8px;width:100%;min-width:0}`, `.editorial-workbench .connections-summary-grid>.connections-card{border-radius:8px}`} {
		if !strings.Contains(body, want) {
	...
	if !strings.Contains(adminThemeCSS, `.editorial-advanced-settings .page-heading,.editorial-advanced-settings>.connection-external-url-field,.editorial-advanced-settings>.connection-expert-network{grid-column:1;grid-row:auto}`) || strings.Contains(adminThemeCSS, `.editorial-advanced-settings .connection-form-field:last-child`) {
