...
/* func init() {
	...
	uiText["en"]["production.unconnected.status"] = "Disconnected"
...
func init() {
	...
	uiText["ja"]["wizard.error.already_connected"] = "\u3053\u306e\u30d7\u30ed\u30c0\u30af\u30b7\u30e7\u30f3\u306f\u3059\u3067\u306b\u9023\u643a\u3055\u308c\u3066\u3044\u307e\u3059"
	...
	uiText["ja"]["wizard.exclude"] = "通知対象から外す"
	uiText["en"]["wizard.exclude"] = "Exclude from notifications"
	uiText["ja"]["wizard.add_task_type"] = "Task Typeを追加"
	uiText["en"]["wizard.add_task_type"] = "Add Task Type"
	uiText["ja"]["wizard.select_task_type"] = "Task Typeを選択"
	uiText["en"]["wizard.select_task_type"] = "Select a Task Type"
	uiText["ja"]["wizard.add"] = "追加"
	uiText["en"]["wizard.add"] = "Add"
	uiText["ja"]["wizard.row_move_hint"] = "%s。Alt+↑/↓で順序を変更できます。"
	uiText["en"]["wizard.row_move_hint"] = "%s. Use Alt+Arrow Up/Down to reorder."
	uiText["ja"]["wizard.exclude"] = "\u901a\u77e5\u5bfe\u8c61\u304b\u3089\u5916\u3059"
	uiText["ja"]["wizard.add_task_type"] = "Task Type\u3092\u8ffd\u52a0"
	uiText["ja"]["wizard.select_task_type"] = "Task Type\u3092\u9078\u629e"
	uiText["ja"]["wizard.add"] = "\u8ffd\u52a0"
	uiText["ja"]["wizard.row_move_hint"] = "%s\u3002Alt+\u2191/\u2193\u3067\u9806\u5e8f\u3092\u5909\u66f4\u3067\u304d\u307e\u3059\u3002"
	uiText["ja"]["wizard.all_task_types_included"] = "すべて追加済み"
	uiText["en"]["wizard.all_task_types_included"] = "All included"
	uiText["ja"]["wizard.execute_title"] = "接続を実行"
	uiText["ja"]["wizard.execute_hint"] = "内容確認で同意した内容を安全に反映しています。"
	uiText["ja"]["wizard.execute_started"] = "接続を開始しています。"
	uiText["ja"]["wizard.back_to_review"] = "内容確認に戻る"
	uiText["ja"]["wizard.complete_title"] = "接続設定が完了しました"
	uiText["ja"]["wizard.complete_message"] = "%s の接続設定を保存しました。"
	uiText["ja"]["wizard.open_production"] = "プロダクションを開く"
	uiText["en"]["wizard.execute_started"] = "Starting the connection."
}
